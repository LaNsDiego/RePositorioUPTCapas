...
namespace Repositorio.PruebasUnitarias
{
    ...
    public class ArticuloPruebasUnitariasDatos
    {
        ...
        {
            var loArticulo = ArticuloMapeo.Registrar("2018010001", "Marco de Trabajo para la Gestión de Requisitos de Software Basado en el Modelo de Impacto Emocional en la Facultad de Ingeniería de la Universidad Privada de Tacna - Tacna",
